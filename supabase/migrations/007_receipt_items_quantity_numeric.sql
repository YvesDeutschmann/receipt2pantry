-- ==============================================================================
-- Support fractional receipt item quantities (e.g. 0.62 lb from Safeway)
-- ==============================================================================

-- Change quantity from INTEGER to NUMERIC so values like "0.62" are valid
ALTER TABLE receipt_items
  ALTER COLUMN quantity TYPE NUMERIC(10,2) USING quantity::numeric,
  ALTER COLUMN quantity SET DEFAULT 1;

-- Recreate store_receipt_with_items to parse quantity as numeric
