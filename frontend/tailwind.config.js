...
export default {
  ...
  theme: {
    extend: {
      ...
      borderRadius: {
        'meald-sm': 'var(--radius-sm)',
        'meald-md': 'var(--radius-md)',
        'meald-lg': 'var(--radius-lg)',
        'meald-xl': 'var(--radius-xl)',
      },
      boxShadow: {
        'card': 'var(--shadow-card)',
        'meald-sm': 'var(--shadow-sm)',
        'meald-md': 'var(--shadow-md)',
        'meald-lg': 'var(--shadow-lg)',
      },
      letterSpacing: {
        'widest-meald': 'var(--tracking-widest)',
      },
    },
  },
  plugins: [],
