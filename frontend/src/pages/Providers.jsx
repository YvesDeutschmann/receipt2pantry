...
function Providers() {
  ...
  return (
    <div>
      ...
      {pollingActive && (
        <div className="fixed bottom-4 right-4 alert alert-info shadow-mise-lg p-3 z-[100] max-w-sm">
          <div className="flex items-center gap-2">
            <div className="animate-spin rounded-full h-4 w-4 border-2 border-forest-mid border-t-terra" />
            <span className="text-sm font-medium">Waiting for device verification...</span>
          </div>
        </div>
      )}
