...
| [`01d-sync-feedback-surfaces.md`](01d-sync-feedback-surfaces.md) | M1 ⭐ | Selective sync toasts + persisted Dashboard "Needs attention" for reconnect | 01b | Yes |
...
M0:  00  ──────────────┐
                        ▼
M1:  01a ─► 01b ─► 01d  01c        (01a/01b/01d frontend chain; 01c backend, parallel)
                        │
M2:                     02a ─► 02b
                        │
M3:  03  (after 01b)    │
...
- **Frontend track:** 00 → 01a → 01b → 01d → 03 → (04, 05)
- **Backend track:** 01c → 02a → 02b
